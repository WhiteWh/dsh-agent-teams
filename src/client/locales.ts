...
export const zh = {
  ...
  'task.status.awaitingScopeReview': '等待范围确认',
  'task.status.completed': '已完成',
  'task.status.failed': '失败',
  'task.status.cancelled': '已取消',
  'task.status.superseded': '已被替换',
  ...
  'task.summary.ended': '终态：{completed} 已交付 · {cancelled} 已取消 · {failed} 失败 · {superseded} 已替换',
  ...
  'progress.percent': '{percent}% · {completed}/{total}',
  'progress.phase': '{percent}% · {completed}/{total}',
  'progress.mode.byKind': '按类型',
  'progress.mode.equal': '等权',
  'progress.mode.hint': '切换进度算法：按任务类型加权 / 每项任务等权',
  'checklist.aria': '任务清单',
  'checklist.title': '任务清单（{count}）',
  'checklist.collapse': '收起',
  'checklist.expand': '展开',
  'checklist.empty': '尚未规划任务',
  'checklist.unassigned': '未分配',
  'checklist.waivers': '免检 {count}',
  'checklist.supersededBy': '→ {task}',
  'replan.aria': '改动计划',
  'replan.title': '改动计划（running）',
  'replan.hint': '一次提交即为一个原子批次：修好契约、让失败的通道重试、替换或取消通道。改动会被记录到计划修订号。',
  'replan.subject': '标题（留空表示不改）',
  'replan.dependencies': '依赖（逗号分隔，留空表示不改）',
  'replan.assignee': '执行者',
  'replan.paths': '要接受的路径（逗号分隔）',
  'replan.phase': '阶段',
  'replan.retry': '重试',
  'replan.supersede': '替换',
  'replan.accept': '接受路径',
  'replan.cancel': '取消',
  'replan.invalidate': '先停止该成员',
  'replan.reason': '整批改动的理由（必填）',
  'replan.apply': '提交批次',
  'replan.applying': '提交中…',
  'replan.applied': '已应用 {count} 项操作，计划修订号 {revision}',
  'replan.empty': '没有要提交的改动',
  'replan.reasonRequired': '请先填写理由',
  'replan.failed': '改动被拒绝',
  'teams.switcher': '团队切换',
  'teams.tab': '{name} · {done}/{total} · {state}',
  'teams.tabWorking': '进行中',
  'teams.tabIdle': '空闲',
  ...
  'view.phases': '阶段',
  'view.queues': '队列',
  'view.tree.hint': '依赖树 · 悬停高亮依赖链',
  'view.phases.hint': '按阶段展开 · 点击节点查看详情',
  'view.queues.hint': '谁在等什么 · 按原因分组',
  'phase.aria': '按阶段查看任务',
  'phase.column': '阶段 {order}',
  'phase.unphased': '未分阶段',
  'phase.empty': '该阶段暂无任务',
  'phase.count': '{count} 项',
  'phase.autoHint': '阶段按依赖层级自动推导；计划声明阶段时以声明为准',
  'agents.busy': '在工作',
  'queue.aria': '成员队列与空闲原因',
  'queue.member': '成员',
  'queue.activity': '状态',
  'queue.current': '当前任务',
  'queue.next': '下一个可领',
  'queue.idleReason': '空闲原因',
  'queue.idleHeadline': '空闲 {idle} / {total}',
  'queue.idle.none': '无人空闲',
  'queue.idle.noTasks': '没有可分派的任务',
  'queue.idle.allDone': '任务均已终结',
  'queue.idle.blockedBy': '等待 {tasks}',
  'queue.idle.waitingReview': '等待审查 {taskId}',
  'queue.current.none': '—',
...
export const en = {
  ...
  'task.status.awaitingScopeReview': 'Awaiting scope review',
  'task.status.completed': 'Completed',
  'task.status.failed': 'Failed',
  'task.status.cancelled': 'Cancelled',
  'task.status.superseded': 'Superseded',
  ...
  'task.summary.ended': 'Final: {completed} delivered · {cancelled} cancelled · {failed} failed · {superseded} superseded',
  ...
  'progress.percent': '{percent}% · {completed}/{total}',
  'progress.phase': '{percent}% · {completed}/{total}',
  'progress.mode.byKind': 'By kind',
  'progress.mode.equal': 'Equal',
  'progress.mode.hint': 'Switch the progress weighting: per task kind / every task equal',
  'checklist.aria': 'Task checklist',
  'checklist.title': 'Task checklist ({count})',
  'checklist.collapse': 'Collapse',
  'checklist.expand': 'Expand',
  'checklist.empty': 'No tasks planned yet',
  'checklist.unassigned': 'unassigned',
  'checklist.waivers': '{count} waived',
  'checklist.supersededBy': '→ {task}',
  'replan.aria': 'Replan the running team',
  'replan.title': 'Replan (running)',
  'replan.hint': 'One submit is one atomic batch: repair a contract, retry a failed lane, replace or cancel one. Every change is recorded against the plan revision.',
  'replan.subject': 'Subject (empty keeps the current one)',
  'replan.dependencies': 'Dependencies (comma separated; empty keeps the current list)',
  'replan.assignee': 'Assignee',
  'replan.paths': 'Paths to accept (comma separated)',
  'replan.phase': 'Phase',
  'replan.retry': 'Retry',
  'replan.supersede': 'Supersede',
  'replan.accept': 'Accept paths',
  'replan.cancel': 'Cancel',
  'replan.invalidate': 'Stop that member first',
  'replan.reason': 'Reason for the whole batch (required)',
  'replan.apply': 'Apply batch',
  'replan.applying': 'Applying…',
  'replan.applied': 'Applied {count} operation(s); plan revision {revision}',
  'replan.empty': 'No change to submit yet',
  'replan.reasonRequired': 'A reason is required',
  'replan.failed': 'The replan was refused',
  'teams.switcher': 'Switch team',
  'teams.tab': '{name} · {done}/{total} · {state}',
  'teams.tabWorking': 'working',
  'teams.tabIdle': 'idle',
  ...
  'view.aria': 'Task view switcher',
  'view.tree': 'Tree',
  'view.phases': 'Phases',
  'view.queues': 'Queues',
  'view.tree.hint': 'Dependency tree · hover to trace the chain',
  'view.phases.hint': 'Grouped by phase · click a node for details',
  'view.queues.hint': 'Who waits for what, grouped by reason',
  'phase.aria': 'Tasks by phase',
  'phase.column': 'Phase {order}',
  'phase.unphased': 'Unphased',
  'phase.empty': 'No tasks in this phase',
  'phase.count': '{count} tasks',
  'phase.autoHint': 'Phases follow the dependency levels unless the plan declares its own',
  'agents.busy': 'Working',
  'queue.aria': 'Member queues and idle reasons',
  'queue.member': 'Member',
  'queue.activity': 'State',
  'queue.current': 'Current task',
  'queue.next': 'Next claimable',
  'queue.idleReason': 'Idle reason',
  'queue.idleHeadline': 'idle {idle} / {total}',
  'queue.idle.none': 'Nobody is idle',
  'queue.idle.noTasks': 'no claimable task',
  'queue.idle.allDone': 'all work settled',
  'queue.idle.blockedBy': 'blocked by {tasks}',
  'queue.idle.waitingReview': 'waiting to review {taskId}',
  'queue.current.none': '—',
