...
export const zh = {
  ...
  'view.agents.hint': '每行一名成员 · 左到右按执行顺序',
  ...
  'agents.blockedTooltip': '等待 {tasks}',
  'agents.idle': '空闲',
  'agents.busy': '在工作',
...
export const en = {
  ...
  'view.agents.hint': 'One row per member, left to right in execution order',
  ...
  'agents.aria': 'Tasks by member',
  'agents.empty': 'No members yet',
  'agents.unassigned': 'Unassigned',
  'agents.blockedTooltip': 'Blocked by {tasks}',
  'agents.idle': 'Idle',
  'agents.busy': 'Working',
